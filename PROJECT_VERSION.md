...
Тяжёлые файлы заказов не должны храниться вечно, но пока заказ активен, файлы нельзя автоматически удалять. Будущая очистка файлов/кабинетов должна быть отдельной задачей с dry-run/report.
