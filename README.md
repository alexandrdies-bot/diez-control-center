...
В навигации ПК-программы раздел `Пользователи и доступ` предназначен только для пользователей программы: менеджеров и администраторов. Заказчики должны управляться отдельно. Правильное место для управления заказчиками: `Настройки -> Клиенты -> Личные кабинеты заказчиков`. Управление личным кабинетом не должно размещаться внутри заказа.
