...
Модель будущей навигации описана в `docs/NAVIGATION_MODEL.md`.

Основные разделы будущей программы:
...
Внутри настроек должны находиться:
...
На текущем этапе не реализовывать роли в коде, не менять текущую навигацию UI, не создавать таблицы и не создавать миграции.
