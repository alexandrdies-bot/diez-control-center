...
* Зафиксировано правило навигации: `Пользователи и доступ` — только пользователи ПК-программы, а заказчики управляются отдельно в `Настройки -> Клиенты -> Личные кабинеты заказчиков`.
...
* Зафиксировано, что автоочистка файлов/кабинетов пока не включена, а будущая очистка должна быть отдельной задачей с dry-run/report.
