...
* Удаление заказа приведено к правилу полного hard-delete: менеджер удаляет заказ из рабочей базы вместе с позициями, доставкой, оплатами, вложениями и историей; карточка клиента сохраняется.
